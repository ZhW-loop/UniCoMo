...
//   };
  Array<Map<String, String>> wmma_intrin_groups = {
      // Tensor Cores f32 += f16 * f16
    //   {
    //       {"init", "wmma_fill_8x32x16_f32"},
    //       {"load_a", "wmma_load_8x32x16_f16_a_shared_dyn"},
    //       {"load_b", "wmma_load_8x32x16_f16_b_shared_dyn"},
    //       {"compute", "wmma_sync_8x32x16_f16f16f32"},
    //       {"store", "wmma_store_8x32x16_f32_shared_dyn"},
    //   },
    //   {
    //       {"init", "wmma_fill_8x32x16_f32"},
    //       {"load_a", "wmma_load_8x32x16_f16_a_shared_dyn"},
    //       {"load_b", "wmma_load_8x32x16_f16_b_trans_shared_dyn"},
    //       {"compute", "wmma_sync_8x32x16_f16f16f32_trans"},
    //       {"store", "wmma_store_8x32x16_f32_shared_dyn"},
    //   },
      // Tensor Cores f16 += f16 * f16
      {
    ...
    //   },
    //   {
    //       {"init", "wmma_fill_8x32x16_f16"},
    //       {"load_a", "wmma_load_8x32x16_f16_a_shared_dyn"},
    //       {"load_b", "wmma_load_8x32x16_f16_b_shared_dyn"},
    //       {"compute", "wmma_sync_8x32x16_f16f16f16"},
    //       {"store", "wmma_store_8x32x16_f16_shared_dyn"},
    //   },
    //   {
    //       {"init", "wmma_fill_8x32x16_f16"},
    //       {"load_a", "wmma_load_8x32x16_f16_a_shared_dyn"},
    //       {"load_b", "wmma_load_8x32x16_f16_b_trans_shared_dyn"},
    //       {"compute", "wmma_sync_8x32x16_f16f16f16_trans"},
    //       {"store", "wmma_store_8x32x16_f16_shared_dyn"},
    //   },
    //   {
    //       {"init", "wmma_fill_32x8x16_f16"},
    //       {"load_a", "wmma_load_32x8x16_f16_a_shared_dyn"},
    //       {"load_b", "wmma_load_32x8x16_f16_b_shared_dyn"},
    //       {"compute", "wmma_sync_32x8x16_f16f16f16"},
    //       {"store", "wmma_store_32x8x16_f16_shared_dyn"},
    //   },
    //   {
    //       {"init", "wmma_fill_32x8x16_f16"},
    //       {"load_a", "wmma_load_32x8x16_f16_a_shared_dyn"},
    //       {"load_b", "wmma_load_32x8x16_f16_b_trans_shared_dyn"},
    //       {"compute", "wmma_sync_32x8x16_f16f16f16_trans"},
    //       {"store", "wmma_store_32x8x16_f16_shared_dyn"},
    //   },
      // Tensor Cores s32 += s8 * s8
    //   {
...
Array<ScheduleRule> ScheduleRule::CUSTOMDefaultCUDATensorCore(const String& type) {
  Array<Array<Map<String, String>>> select_wmma_intrin_groups;
  Array<Map<String, String>> wmma_intrin_groups_161616nn = {
      // Tensor Cores f16 += f16 * f16
      {
          {"init", "wmma_fill_16x16x16_f16"},
          {"load_a", "wmma_load_16x16x16_f16_a_shared_dyn"},
  ...
  select_wmma_intrin_groups.push_back(wmma_intrin_groups_161616nn);

  Array<Map<String, String>> wmma_intrin_groups_161616nt = {
      // Tensor Cores f16 += f16 * f16
      {
          {"init", "wmma_fill_16x16x16_f16"},
          {"load_a", "wmma_load_16x16x16_f16_a_shared_dyn"},
  ...
  select_wmma_intrin_groups.push_back(wmma_intrin_groups_161616nt);

  Array<Map<String, String>> wmma_intrin_groups_83216nn = {
      // Tensor Cores f16 += f16 * f16
      {
          {"init", "wmma_fill_8x32x16_f16"},
          {"load_a", "wmma_load_8x32x16_f16_a_shared_dyn"},
  ...
  select_wmma_intrin_groups.push_back(wmma_intrin_groups_83216nn);

  Array<Map<String, String>> wmma_intrin_groups_83216nt = {
      // Tensor Cores f16 += f16 * f16
      {
          {"init", "wmma_fill_8x32x16_f16"},
          {"load_a", "wmma_load_8x32x16_f16_a_shared_dyn"},
  ...
  select_wmma_intrin_groups.push_back(wmma_intrin_groups_83216nt);
  
  Array<Map<String, String>> wmma_intrin_groups_32816nn = {
      // Tensor Cores f16 += f16 * f16
      {
          {"init", "wmma_fill_32x8x16_f16"},
          {"load_a", "wmma_load_32x8x16_f16_a_shared_dyn"},
  ...
  select_wmma_intrin_groups.push_back(wmma_intrin_groups_32816nn);

  Array<Map<String, String>> wmma_intrin_groups_32816nt = {
      // Tensor Cores f16 += f16 * f16
      {
          {"init", "wmma_fill_32x8x16_f16"},
          {"load_a", "wmma_load_32x8x16_f16_a_shared_dyn"},
  ...
  select_wmma_intrin_groups.push_back(wmma_intrin_groups_32816nt);
  int select_id = -1;
  if(type == "cuda-tensorcore-161616nn"){
    select_id = 0;
  }
  else if (type == "cuda-tensorcore-161616nt"){
    select_id = 1;
  }
  else if (type == "cuda-tensorcore-83216nn"){
    select_id = 2;
  }
  else if (type == "cuda-tensorcore-83216nt"){
    select_id = 3;
  }
  else if (type == "cuda-tensorcore-32816nn"){
    select_id = 4;
  }
  else if (type == "cuda-tensorcore-32816nt"){
    select_id = 5;
  }
  Array<ScheduleRule> results{
      ScheduleRule::ApplyCustomRule(),
      ScheduleRule::MultiLevelTilingTensorCore(
          /*intrin_groups=*/select_wmma_intrin_groups[select_id],
          /*structure=*/"SSSRRSRS",
          /*tile_binds=*/Array<String>{"blockIdx.y", "blockIdx.x", "threadIdx.y"},
          /*max_innermost_factor=*/Integer(4),
          /*vector_load_lens=*/Array<Integer>{1, 2, 3, 4, 8, 16},
...
// CUSTOMIZE
TVM_REGISTER_GLOBAL("meta_schedule.ScheduleRuleDefaultX86")
    .set_body_typed(ScheduleRule::DefaultX86);

TVM_REGISTER_GLOBAL("meta_schedule.CUSTOMDefaultCUDATensorCore")
    .set_body_typed(ScheduleRule::CUSTOMDefaultCUDATensorCore);
// CUSTOMIZE

// CUSTOMIZE

TVM_REGISTER_GLOBAL("meta_schedule.GetARMNeonSpecificRules")
    .set_body_typed(GetARMNeonSpecificRules);
