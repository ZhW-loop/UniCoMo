...
WMMA_SYNC_8x32x16_f16f16f16_TRANS_INTRIN = "wmma_sync_8x32x16_f16f16f16_trans"
TensorIntrin.register(
    WMMA_SYNC_8x32x16_f16f16f16_TRANS_INTRIN,
    *get_wmma_sync_intrin(8, 32, 16, "float16", "float16", True),
)
...
TensorIntrin.register(WMMA_FILL_8x32x16_F16_INTRIN, *get_wmma_fill_intrin(8, 32, 16, "float16"))

WMMA_STORE_8x32x16_F16_SHARED_INTRIN = "wmma_store_8x32x16_f16_shared"
TensorIntrin.register(
    WMMA_STORE_8x32x16_F16_SHARED_INTRIN, *get_wmma_store_intrin(8, 32, 16, "float16", "shared")
)
...
WMMA_SYNC_32x8x16_f16f16f16_TRANS_INTRIN = "wmma_sync_32x8x16_f16f16f16_trans"
TensorIntrin.register(
    WMMA_SYNC_32x8x16_f16f16f16_TRANS_INTRIN,
    *get_wmma_sync_intrin(32, 8, 16, "float16", "float16", True),
)
...
TensorIntrin.register(WMMA_FILL_32x8x16_F16_INTRIN, *get_wmma_fill_intrin(32, 8, 16, "float16"))

WMMA_STORE_32x8x16_F16_SHARED_INTRIN = "wmma_store_32x8x16_f16_shared"
TensorIntrin.register(
    WMMA_STORE_32x8x16_F16_SHARED_INTRIN, *get_wmma_store_intrin(32, 8, 16, "float16", "shared")
)
