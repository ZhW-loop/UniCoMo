...
class Postproc(Object):
    ...
    @staticmethod
    def create(kind: Literal["llvm", "cuda", "cuda-tensorcore", "hexagon", "avx512", "vnni", "neon"]) -> List["Postproc"]:
        ...
        funcs = {
            ...
            "avx512": _ffi_api.PostprocDefaultCPUTensorization,
            "vnni": _ffi_api.PostprocDefaultCPUTensorization,
            "neon": _ffi_api.PostprocDefaultCPUTensorization,
