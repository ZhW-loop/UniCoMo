...
class ScheduleRule(Object):
    ...
    @staticmethod
    def create(kind: Literal["llvm", "cuda", "cuda-tensorcore", "hexagon", "avx512", "vnni", "neon"]) -> List["ScheduleRule"]:
        ...
        funcs = {
            ...
            "cuda-tensorcore-161616nn":_ffi_api.CUSTOMDefaultCUDATensorCore,
            "cuda-tensorcore-161616nt":_ffi_api.CUSTOMDefaultCUDATensorCore,
            "cuda-tensorcore-83216nn":_ffi_api.CUSTOMDefaultCUDATensorCore,
            "cuda-tensorcore-83216nt":_ffi_api.CUSTOMDefaultCUDATensorCore,
            "cuda-tensorcore-32816nn":_ffi_api.CUSTOMDefaultCUDATensorCore,
            "cuda-tensorcore-32816nt":_ffi_api.CUSTOMDefaultCUDATensorCore,
            "hexagon": _ffi_api.ScheduleRuleDefaultHexagon,  # type: ignore
            "avx512": _ffi_api.ScheduleRuleDefaultX86,
            "vnni": _ffi_api.ScheduleRuleDefaultX86,
            "neon": _ffi_api.ScheduleRuleDefaultARM,
            # pylint: enable=no-member
        }
        for k, v in funcs.items():
            if k == kind:
                if kind == "avx512" or kind == "vnni" \
                    or kind == "cuda-tensorcore-161616nn" or kind == "cuda-tensorcore-161616nt" \
                        or kind == "cuda-tensorcore-83216nn" or kind == "cuda-tensorcore-83216nt" \
                            or kind == "cuda-tensorcore-32816nn" or kind == "cuda-tensorcore-32816nt" \
                                or kind =="neon":
                    return v(kind)
                return v()
